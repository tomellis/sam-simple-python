...
This is a sample template for sam-simple-python - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-simple-python --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-simple-python
```
